...
wide_d10_no_na$"Nighttime Sleep" <- (nighttime_sleep)

wide_d10_no_na$"Light-Intensity Physical Activity" <- wide_d10_no_na$`Work and Household Light-Intensity Physical Activity` + wide_d10_no_na$`Unstructured Leisure Time Light-Intensity Physical Activity`
wide_d10_no_na$"Moderate- to Vigorous- Intensity Physical Activity" <- wide_d10_no_na$`Active Transportation` + wide_d10_no_na$`Unstructured Leisure Time Moderate- to Vigorous- Intensity Physical Activity` + wide_d10_no_na$`Structured Leisure Time Moderate- to Vigorous- Intensity Physical Activity`
wide_d10_no_na$"Sedentary Behaviour" <- wide_d10_no_na$`Leisure Time Sedentary Behaviour` + wide_d10_no_na$`Social-Based Sedentary Behaviour` + wide_d10_no_na$`Recreational Screen Time` + wide_d10_no_na$`Education-Based Sedentary Behaviour` + wide_d10_no_na$`Self Care Sedentary Behaviour`
wide_d10_no_na$"Sleep" <- wide_d10_no_na$`Daytime Naps` + wide_d10_no_na$`Nighttime Sleep`



wide_d10[!is.na(wide_d10$sleep_time_num),] -> wide_d10_no_na
