...
#completed_wide_d10$total_general_movement_behaviours <- completed_wide_d10$sedentary_behaviour_at_10 + completed_wide_d10$moderate_to_vigorous_intensity_physical_activity_at_10 + completed_wide_d10$light_intensity_physical_activity_at_10 + completed_wide_d10$sleep_time_at_10 + completed_wide_d10$uncodeable_activity_at_10

#completed_wide_d10$total_domain_specific_movement_behaviours <- completed_wide_d10$`Active Transportation` + completed_wide_d10$`Work and Household Light-Intensity Physical Activity` + completed_wide_d10$`Unstructured Leisure Time Light-Intensity Physical Activity` + completed_wide_d10$`Unstructured Leisure Time Moderate- to Vigorous- Intensity Physical Activity` + completed_wide_d10$`Structured Leisure Time Moderate- to Vigorous- Intensity Physical Activity` + completed_wide_d10$`Leisure Time Sedentary Behaviour` + completed_wide_d10$`Social-Based Sedentary Behaviour` + completed_wide_d10$`Recreational Screen Time` + completed_wide_d10$`Education-Based Sedentary Behaviour` + completed_wide_d10$`Self Care Sedentary Behaviour` + completed_wide_d10$`Passive Transportation` + completed_wide_d10$`Daytime Naps` + completed_wide_d10$`Nighttime Sleep` + completed_wide_d10$`Uncodeable Activity at 10`

#completed_wide_d10$total_general_movement_behaviours[completed_wide_d10$total_general_movement_behaviours == 1440]
#completed_wide_d10$total_general_movement_behaviours[completed_wide_d10$total_general_movement_behaviours <= 1440]
#hist(completed_wide_d10$total_general_movement_behaviours)
