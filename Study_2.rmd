...
``` {r}
#Assign TUD activity codes to domain-specific variables  
...
#Make decision rules based on main activities and secondary activities 
  mutate(domain_specific_movement_behaviour = case_when(
    ...
    (mainact %in% social_sb & secact1 %in% lt_sb & secact2 %in% unstr_lt_pa & secact3 %in% no_secact) ~ "Unstructured Leisure Time Light-Intensity Physical Activity",
    ...
    (mainact %in% passive_trans & secact1 %in% unstr_lt_pa & secact2 %in% active_trans & secact3 %in% social_sb) ~ "Unstructured Leisure Time Light-Intensity Physical Activity",
