...
#Make decision rules based on main activities and secondary activities 
  ...
  dcast(hicid ~ c(domain_specific_movement_behaviour, general_movement_behaviour), value.var="total_minutes", fun.aggregate = sum)

#is.na(domain_specific_movement_behaviour)
