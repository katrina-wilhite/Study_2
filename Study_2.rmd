...
```{r}
#Decide how many profiles should be used for latent profile analysis for general movement behaviours 
completed_wide_d10 %>%
...
#Results say Model 6 with 4 classes is the best fit solution. 
completed_wide_d10 %>% 
  select(sedentary_behaviour_at_10, light_intensity_physical_activity_at_10, moderate_to_vigorous_intensity_physical_activity_at_10, sleep_at_10) %>% 
  estimate_profiles(4, 
                    variances = "varying",
