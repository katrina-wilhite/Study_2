...
d10 %>% 
  mutate(domain_main_activity = case_when(
    ...
    mainact %in% unstr_lt_mvpa ~ "Unstructured Leisure Time Moderate- to Vigorous- Physical Activity",
  ...
  mutate(domain_secondary1_activity = case_when(
    ...
    secact1 %in% unstr_lt_mvpa ~ "Unstructured Leisure Time Moderate- to Vigorous- Physical Activity",
  ...
  mutate(domain_secondary2_activity = case_when(
    ...
    secact2 %in% unstr_lt_mvpa ~ "Unstructured Leisure Time Moderate- to Vigorous- Physical Activity",
  ...
  mutate(domain_specific_movement_behaviour = case_when(
    ...
    (mainact %in% unstr_lt_mvpa & secact1 %in% no_secact) ~ "Unstructured Leisure Time Moderate- to Vigorous- Physical Activity",
    ...
    (mainact %in% unstr_lt_mvpa & secact1 %in% unstr_lt_mvpa & secact2 %in% no_secact) ~ "Unstructured Leisure Time Moderate- to Vigorous- Physical Activity",
    ...
    (mainact %in% wrk_hh_pa & secact1 %in% social_sb & secact2 %in% no_secact) ~ "Social-Based Sedentary Behavour",
