...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_gen_weekend[[i]]$ic[["aic"]],
      results_gen_weekend[[i]]$ic[["bic"]],
      paste0(results_gen_weekend[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_gen_weekend[[i]]$posterior,
          results_gen_weekend[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0("./FCAP/FCAP_gen_weekends/FCAP CSV Files_models1_5/",
           "universal_",
           grps,
           ".csv")
...
make_csvs <- function(i) {
  ...
  out_table <-
    merge(results_gen_weekend[[i]]$posterior,
          ...
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0("./FCAP/FCAP_gen_weekends/FCAP CSV Files_models6_10/",
           "universal_",
           grps,
           ".csv")
  cat(first_line, file = filename)
...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_domsp_weekday[[i]]$ic[["aic"]],
      results_domsp_weekday[[i]]$ic[["bic"]],
      paste0(results_domsp_weekday[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_domsp_weekday[[i]]$posterior,
          results_domsp_weekday[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0(
      "./FCAP/FCAP_domsp_weekdays/FCAP CSV Files_models1_5/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  filename <-
    paste0(
      "./FCAP/FCAP_domsp_weekdays/FCAP CSV Files_models6_10/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_domsp_weekend[[i]]$ic[["aic"]],
      results_domsp_weekend[[i]]$ic[["bic"]],
      paste0(results_domsp_weekend[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_domsp_weekend[[i]]$posterior,
          results_domsp_weekend[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0(
      "./FCAP/FCAP_domsp_weekends/FCAP CSV Files_models1_5/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  filename <-
    paste0(
      "./FCAP/FCAP_domsp_weekends/FCAP CSV Files_models6_10/",
      "universal_",
      grps,
      ".csv"
    )
...
df <-
  haven::read_dta(
    "Z:\\LSAC dataset\\Study_2\\Study_2\\Multi_Trajecotry_Analysis_Domain_Specific_Movement_Behaviours.dta"
  )
...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_sens_gen_weekday[[i]]$ic[["aic"]],
      results_sens_gen_weekday[[i]]$ic[["bic"]],
      paste0(results_sens_gen_weekday[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_sens_gen_weekday[[i]]$posterior,
          results_sens_gen_weekday[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_gen_weekdays_sensitivity/FCAP CSV Files_models1_5/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_gen_weekdays_sensitivity/FCAP CSV Files_models6_10/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_sens_gen_weekend[[i]]$ic[["aic"]],
      results_sens_gen_weekend[[i]]$ic[["bic"]],
      paste0(results_sens_gen_weekend[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_sens_gen_weekend[[i]]$posterior,
          results_sens_gen_weekend[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_gen_weekends_sensitivity/FCAP CSV Files_models1_5/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_gen_weekends_sensitivity/FCAP CSV Files_models6_10/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_sens_domsp_weekday[[i]]$ic[["aic"]],
      results_sens_domsp_weekday[[i]]$ic[["bic"]],
      paste0(results_sens_domsp_weekday[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_sens_domsp_weekday[[i]]$posterior,
          results_sens_domsp_weekday[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_domsp_weekdays_sensitivity/FCAP CSV Files_models1_5/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_domsp_weekdays_sensitivity/FCAP CSV Files_models6_10/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  first_line <-
    paste(
      results_sens_domsp_weekend[[i]]$ic[["aic"]],
      results_sens_domsp_weekend[[i]]$ic[["bic"]],
      paste0(results_sens_domsp_weekend[[i]]$logLik, "\n"),
      sep = ","
    )
  out_table <-
    merge(results_sens_domsp_weekend[[i]]$posterior,
          results_sens_domsp_weekend[[i]]$assign,
          by = "row.names")[, 2:grpcols]
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_domsp_weekends_sensitivity/FCAP CSV Files_models1_5/",
      "universal_",
      grps,
      ".csv"
    )
...
make_csvs <- function(i) {
  ...
  filename <-
    paste0(
      "./FCAP/Sensitivity Analyses/FCAP_domsp_weekends_sensitivity/FCAP CSV Files_models6_10/",
      "universal_",
      grps,
      ".csv"
    )
